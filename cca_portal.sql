...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2023 at 06:51 AM
...
INSERT INTO `courses` (`id`, `course_code`, `course_title`, `institute`) VALUES
(1, 'BSA', 'Bachelor of Science in Accountancy', 'IBM'),
(2, 'BSE', 'Bachelor of Science in Entrepreneurship', 'IBM'),
(3, 'BSTM', 'Bachelor of Science in Tourism Management', 'IBM'),
(4, 'BSCS', 'Bachelor of Science in Computer Science', 'ICSLIS'),
(5, 'ACT', 'Associate in Computer Technology', 'ICSLIS'),
(6, 'BSIS', 'Bachelor of Science in Information Systems', 'ICSLIS'),
(7, 'BLIS', 'Bachelor of Library and Information Science', 'ICSLIS'),
(8, 'BSM', 'Bachelor of Science in Mathematics', 'IEAS'),
(9, 'BSNE', 'Bachelor of Special Needs Education', 'IEAS'),
(10, 'BSP', 'Bachelor of Science in Psychology', 'IEAS'),
(11, 'BPE', 'Bachelor of Physical Education', 'IEAS'),
(12, 'BTVTED', 'Bachelor of Technical Vocational Teacher Education', 'IEAS'),
(13, 'BAELS', 'Bachelor of Arts in English Language Studies', 'IEAS');
...
(3, 'CHEM201', 'General Chemistry', 2, 3, 4, 'CHEM101', 2),
(4, 'BIO301', 'Biology 1', 3, 1, 4, 'CHEM201', 3),
(5, 'PHYS101', 'Physics 1', 3, 2, 4, 'MATH101', 1),
...
(9, 'COMP401', 'Computer Programming', 3, 2, 4, 'MATH101', 4),
...
(1, 'cca-avatar.png', 'Admin', 'CCA', NULL, NULL, 'MISSO', NULL, 'CCA-Admin@cca.edu.ph', 'CCA-Admin', 'changed', '$2y$10$AGkdHZZGPoAupwxfbpWTx.ardK0dew/gNzV3prryRB15AlA8tX2uC', 'Admin', '2023-06-19 11:26:31', '2023-06-19 12:49:43', 1),
