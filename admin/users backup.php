    ...
    <div class="d-flex flex-column w-50">
        ...
        <div class="d-flex justify-content-end">
            <div class="d-flex mx-2">
                <a class='btn bg-white border border-dark d-flex' href='../assets/includes/admin/users/add'>
                    Add User
                </a>
            </div>
            <div class="d-flex mx-2">
                <a class="btn bg-white border border-dark d-flexx justify-content-center align-items-center" href="./import/users">
...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <form method="POST" action='../assets/includes/admin/user.inc.php?deleteSelectedUser' id="userListform">
