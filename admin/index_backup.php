...
<div class="d-flex flex-row">
	<div class="container w-100">
		...
		<div class="container">
				...
				<h1 id="page-title" class="h2">User Logs</h1>
					
			<div class="card m-2">
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-striped table-sm w-100" id="user-logs"></table>
					</div>
				</div>
			</div>
	...
	<div class="w-30 ">
		<h1 id="page-title" class="h2">Calendar</h1>
		<div class="card">
			<div class="card-body">
		...
		<h1 id="page-title" class="h2">Events</h1>
		<div class="card">
		<div class="card-body">
