...
<div class="card">
    <form class="card-body" action="../../assets/includes/admin/user.inc.php" method="POST">
                    ...
                    <div class='col-md-6'>
                        <div class='row'>
                            <div class='col-md-4'>
                				...
                				<input class='form-control form-control-lg' type='text' name='institute' value='" . $row["institute"] . "' required>
                				</div>
                			</div>
                		...
                		<div class='row'>
                            <div class='col-md-4'>
                                <div class='mb-3'>
                					...
                					<input class='form-control form-control-lg' type='text' name='username' value='" . $row["username"] . "' required>
                				</div>
                			</div>
