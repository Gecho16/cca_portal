                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-select form-select-lg" id="institute_name" name="institute_name" required>
                            </input>
                        </div>
                    </div> 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-select form-select-lg" id="institute_code" name="institute_code" required>
                            </input>
                        </div>
                    </div>
