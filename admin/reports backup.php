...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <form method="POST" action='' id="reportsform">
                <table class="table table-striped table-sm w-100" id="reports"></table>
            </form>
        </div>
    </div>
</div>
...
function studentInfoTable(){
    ...
    $.getScript('../assets/js/admin/reports/'+ view +'-table-script.js');
}
...
$( document ).ready(function() {
    ...
    $('#tableSelect').on('change', function() {
        ...
        var parentContainer = $('#reportsform');
        var newTable = $('<table class="table table-striped table-sm w-100" id="reports"></table>');
