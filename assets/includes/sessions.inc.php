...
if (isset($_POST["submitSignIn"])) {
	...
	if (mysqli_num_rows($result) > 0) {
		while ($row = mysqli_fetch_assoc($result)) {
			...
			$sql = "UPDATE user_accounts SET last_login = '$currentLogin', current_login = '$today' WHERE id = $userId";
...
if (isset($_POST["submitSetPassword"])) {
	...
	$sql = "UPDATE user_accounts SET initial_password = 'changed', password = '$password' WHERE id = $userId";
