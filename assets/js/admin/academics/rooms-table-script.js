...
$('#academics').DataTable({
    ...
    buttons: [
        ...
        // JSON datasource
        "ajax":{
            url :"../../assets/api/admin/academics/rooms.inc.php?selectYear", 
            type: "POST",
        // Prevent error form
        error: function(){
    ...
    columns: [
        ...
        { data: 2, title: "Room Code", orderable: true, visible: true },
        { data: 3, title: "Room Name", orderable: true, visible: true },
        { data: 4, title: "Type", orderable: true, visible: true },
        { data: 5, title: "Location", orderable: true, visible: true },
        { data: 6, title: "Status", orderable: true, visible: true },
        { data: 7, title: actionBullet, orderable: false, visible: true },
    ],
