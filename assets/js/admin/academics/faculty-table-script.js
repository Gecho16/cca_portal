...
$('#academics').DataTable({
    ...
    buttons: [
        ...
        // JSON datasource
        "ajax":{
            url :"../../assets/api/admin/academics/faculty.inc.php?selectYear", 
            type: "POST",
        // Prevent error form
        error: function(){
    ...
    columns: [
        ...
        { data: 2, title: "Fullname", orderable: true, visible: true },
        { data: 3, title: "Firstname", orderable: true, visible: false },
        { data: 4, title: "Lastname", orderable: true, visible: false },
        { data: 5, title: "Middlename", orderable: true, visible: false },
        { data: 6, title: "Suffix", orderable: true, visible: false },
        { data: 7, title: "Institute", orderable: true, visible: true },
        { data: 8, title: "Reference Number", orderable: true, visible: true },
        { data: 9, title: "Type", orderable: true, visible: true },
        { data: 10, title: actionBullet, orderable: false, visible: true },
    ],
