...
$('#academics').DataTable({
    ...
    buttons: [
        ...
        // JSON datasource
        "ajax":{
            url :"../../assets/api/admin/academics/sections.inc.php?selectYear", 
            type: "POST",
        // Prevent error form
        error: function(){
    ...
    columns: [
        ...
        { data: 3, title: "Course", orderable: true, visible: true },
        { data: 4, title: "Year Level", orderable: true, visible: true },
        { data: 5, title: "Adviser", orderable: true, visible: true },
