...
$('#academics').DataTable({
    ...
    buttons: [
        ...
        // JSON datasource
        "ajax":{
            url :"../../assets/api/admin/academics/courses.inc.php?selectYear", 
            type: "POST",
        // Prevent error form
        error: function(){
    ...
    columns: [
        ...
        { data: 2, title: "Course Code", orderable: true, visible: true },
        { data: 3, title: "Course Title", orderable: true, visible: true },
        { data: 4, title: "Institute", orderable: true, visible: true },
